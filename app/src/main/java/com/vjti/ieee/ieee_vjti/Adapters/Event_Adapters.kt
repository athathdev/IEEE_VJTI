 ...
 */
class Event_Adapters (stations: ArrayList<Card_Info_Collector>): RecyclerView.Adapter<Card_Event_View_Holder>() {
    private var stations: ArrayList<Card_Info_Collector>? = null
